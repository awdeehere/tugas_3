                ...
                <div class="row first">
                    <div class="col-md-5 col-sm-6 col-xs-12">
                        <div class="trend-img hover-images">
                                ...
                                <img class="img-responsive" src="{{url ('public')}}/img/home1/asahi.png" alt="">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">White Strip Sracft Top</a>
                                    </h3>
                                    <div class="product-price">
                                        <span class="old">IDR 210.989</span>
                                        <span>IDR 140.659</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                <div class="product-img">
                                    <a href=""><img src="{{url ('public')}}/img/home1/produk (2).png" alt="" class="img-responsive"></a>
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">Ocean Blue Strip Top</a>
                                    </h3>
                                    <div class="product-price">
                                        <span>IDR 145.766</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                <div class="product-img">
                                    <a href=""><img src="{{url ('public')}}/img/home1/produk (3).png" alt="" class="img-responsive"></a>
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">New Ocean Top</a>
                                    </h3>
                                    <div class="product-price">
                                        <span>IDR 176.897</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                <div class="product-img">
                                    <a href=""><img src="{{url ('public')}}/img/home1/produk (4).png" alt="" class="img-responsive"></a>
                                    <div class="product-button-group">
                                        <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">Sky Blue T-shirt</a>
                                    </h3>
                                    <div class="product-price">
                                        <span>IDR 128.980</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                <div class="product-img">
                                    <a href=""><img src="{{url ('public')}}/img/home1/produk (5).png" alt="" class="img-responsive"></a>
                                    <div class="product-button-group">
                                        <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">Bluish Outline Top</a>
                                    </h3>
                                    <div class="product-price">
                                        <span>IDR 199.900</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 product-item">
                                <div class="product-img">
                                    <a href=""><img src="{{url ('public')}}/img/home1/produk (6).png" alt="" class="img-responsive"></a>
                                ...
                                <div class="product-info text-center">
                                    <h3 class="product-title">
                                        <a href="">Lover T-shirt </a>
                                    </h3>
                                    <div class="product-price">
                                        <span>IDR 98.000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
