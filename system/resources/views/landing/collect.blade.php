                        ...
                        <div class="col-md-9 col-xs-4 col-sm-4 col2 flex justify-content-end">
                            ...
                            <li class="level1 active dropdown">
                                ...
                                <li class="level1 hassub dropdown">
                                    <a href="{{url ('collection')}}" title="Collection">Collection</a>
                                </li>
                ...
                <div class="row engoc-row-equal">
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_1.jpg" alt="" class="img-responsive"></a>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_2.jpg" alt="" class="img-responsive"></a>
                            <div class="product-button-group">
                                <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Yellow Strip Denim Jacket</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 465.788</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_3.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Ripped Deim Jacket</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 234.887</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_4.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Suede Rider Jacket</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 345.980</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_5.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Check-Denim Hybrid Shirt</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 208.345</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_6.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Watch Print Track Jacket</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 578.908</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_7.jpg" alt="" class="img-responsive"></a>
                            <div class="product-button-group">
                                <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Boomber Purle Jacket</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 234.689</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_8.jpg" alt="" class="img-responsive"></a>
                            <div class="product-button-group">
                                <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">American Flag Embroidered Sweatshirt</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 378.987</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_9.jpg" alt="" class="img-responsive"></a>
                            <div class="product-button-group">
                                <a href="#" class="zoa-btn zoa-quickview">
                                    <span class="zoa-icon-quick-view"></span>
                                </a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Emerland Green Turtleneck Sweater</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 356.986</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_10.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">White Chuck 70 Low Top Shoe</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 200.987</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_11.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">Orange Block Turtleneck</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 278.900</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-item">
                        <div class="product-img">
                            <a href=""><img src="{{('public')}}/img/product/product_12.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="product-info text-center">
                            <h3 class="product-title">
                                <a href="">White-Emerland Shirt</a>
                            </h3>
                            <div class="product-price">
                                <span>IDR 178.898</span>
                            </div>
                        </div>
                    </div>
                </div>
